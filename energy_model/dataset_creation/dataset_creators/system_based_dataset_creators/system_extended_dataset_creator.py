...
from energy_model.dataset_creation.dataset_creators.extended_dataset_creator import ExtendedDatasetCreator


class SystemExtendedDatasetCreator(ExtendedDatasetCreator):
