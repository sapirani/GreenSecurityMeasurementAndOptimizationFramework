...
custom_scan_path = fr'"C:\Users\sagib\Downloads"'  # relevant only for custom scans. On other types, must be empty

MINIMUM_DELTA_CAPACITY = 20
MINIMUM_SCAN_TIME = 0.5 * MINUTE

measurement_number = 8080    # write number between 1->inf or type NEW_MEASUREMENT
