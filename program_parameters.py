...
custom_scan_path = fr'"C:\Users\Administrator\Desktop\University\Green Security Project\GreenSecurity-FirstExperiment\Data\{directory_type}\{file_type}"'  # relevant only for custom scans. On other types, must be empty
