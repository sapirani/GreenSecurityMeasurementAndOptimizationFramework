...
from results_analyzer.paths_extractor import PathsExtractor
...
def print_results_graphs_per_container(container_results_dir: str, paths_extractor: PathsExtractor):
...
def print_results_graphs(results_dir: str, paths_extractor: PathsExtractor):
