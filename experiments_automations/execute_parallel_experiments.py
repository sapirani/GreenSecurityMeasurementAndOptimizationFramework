...
def run_various_experiments(num_of_experiments: int, num_of_parallel_tasks: int, main_session_id: str,
    ...
    possible_tasks_combinations = list(itertools.combinations(DEFAULT_TASKS, num_of_parallel_tasks))
...
if __name__ == '__main__':
    ...
    run_various_experiments(number_of_experiments, number_of_parallel_tasks,
