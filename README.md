...
A link to a shared direcctory which contains the various files that were part of the experiments, e.g. the antivirus performed custom scan on these files:
https://drive.google.com/drive/folders/1Cqmpq4cy4UDN8SOqAAWFbsAjMuw7vwPH?usp=drive_link
