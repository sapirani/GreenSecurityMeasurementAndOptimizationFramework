from measurements_model_pipeline.config import SCORING_METHODS_FOR_MODEL
...
def run_grid_search():
    ...
    best_model = model_selector.choose_best_model(SCORING_METHODS_FOR_MODEL, X_train, X_test, y_train, y_test)
    print("Setup:")
