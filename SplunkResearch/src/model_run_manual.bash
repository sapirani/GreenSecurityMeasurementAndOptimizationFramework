...
# echo $password | sudo -S  -E env PATH="$PATH" python3 "$PYTHON_SCRIPT" baseline $test_experiment $test_episodes random
# wait
# echo $password | sudo -S  -E env PATH="$PATH" python3 "$PYTHON_SCRIPT" no_agent $test_experiment $test_episodes
# wait
