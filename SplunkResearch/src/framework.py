...
class Framework(gym.Env):
    def __init__(self, log_generator_instance, splunk_tools_instance, dt_manager, logger, time_range, rule_frequency, search_window, limit_learner=True, reward_parameter_dict=None, relevant_logtypes=[], max_actions_value=10):
