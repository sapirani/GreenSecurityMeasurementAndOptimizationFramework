...
fields_wineventlog = ['LogName', 'EventCode', 'ComputerName', 'RecordNumber', 'TaskCategory']

# Define some possible replacement values
replacement_values_wineventlog = {
'LogName': ['System', 'Application', 'Security', 'Setup', 'ForwardedEvents'],
...
fields_sysmon = ['EventID', 'Version', 'Level', 'Task', 'Opcode', 'Keywords', 'Computer', 'Provider', 'RuleName', 'Image', 'Description', 'Product', 'Company', 'OriginalFileName']
