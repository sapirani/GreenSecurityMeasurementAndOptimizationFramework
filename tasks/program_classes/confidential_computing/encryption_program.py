...
class EncryptionProgram(ProgramInterface, ABC):
    def __init__(self, messages_file: str, results_file: str, security_algorithm: EncryptionType, block_mode: Optional[str], key_file: str, encryption_task_path: str, min_key_value: Optional[int] = None, max_key_value: Optional[int] = None):
        super().__init__()
        self.__messages_file = messages_file
        self.__results_file = results_file
        self.__security_algorithm = security_algorithm.value
        self.__security_algorithm_mode = block_mode
