...
class EncryptionProgram(ProgramInterface, ABC):
    def __init__(self, messages_file: str, security_algorithm: EncryptionType, key_file: str, encryption_task_path: str, min_key_value: Optional[int] = None, max_key_value: Optional[int] = None):
        super().__init__()
