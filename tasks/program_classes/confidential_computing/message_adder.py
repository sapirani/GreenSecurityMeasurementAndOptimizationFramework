...
from tasks.programs.confidential_computing_tasks.encryption_type import EncryptionMode, EncryptionType
from tasks.program_classes.confidential_computing.encryption_program import EncryptionProgram

MESSAGE_ADDITION_TASK = r'message_addition.py'

class MessageAdder(EncryptionProgram):
    def __init__(self, messages_file: str, results_file: str, security_algorithm: EncryptionType,
        ...
        super().__init__(messages_file, results_file, security_algorithm, block_mode, key_file, MESSAGE_ADDITION_TASK,
