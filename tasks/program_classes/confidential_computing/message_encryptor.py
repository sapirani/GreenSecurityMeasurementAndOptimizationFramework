...
class MessageEncryptor(ProgramInterface):
    ...
    def get_command(self) -> str:
        return fr"python {os.path.join(CONFIDENTIAL_COMPUTING_TASKS_DIR, MESSAGE_ENCRYPTION_TASK)} -m {self.__messages_file} -a {self.__security_algorithm} -k {self.__key_file}"
