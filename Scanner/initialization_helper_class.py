...
def initialize_variables():
    ...
    return running_os, scanner_imp, summary_version_imp, chosen_power_plan_name, chosen_power_plan_guid, chosen_power_plan_linux_identifier, balanced_power_plan_name, balanced_power_plan_guid, power_save_plan_name, power_save_plan_identifier, program, background_programs, base_dir, calc_measurement_number, result_paths, battery_columns_list, memory_columns_list, cores_names_list, cpu_columns_list, disk_io_columns_list, processes_columns_list
