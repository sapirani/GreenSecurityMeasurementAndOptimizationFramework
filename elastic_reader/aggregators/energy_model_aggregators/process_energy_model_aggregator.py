...
class ProcessEnergyModelAggregator(EnergyModelAggregator):
    ...
    def name(self) -> AggregationType:
        return AggregationType.ProcessEnergyModelAggregator
    ...
    def extract_features(self, raw_results: ProcessSystemRawResults,
                         iteration_metadata: IterationMetadata) -> Union[CompleteEnergyModelFeatures, EmptyFeatures]:
        return self._energy_model_feature_extractor.extract_process_energy_model_features(raw_results,
                                                                                          iteration_metadata.timestamp)

    def process_sample(self, sample: Union[CompleteEnergyModelFeatures, EmptyFeatures]) -> Union[
