...
class EnergyModelAggregator(AbstractAggregator):
    ...
    def process_sample(self, sample: Union[EnergyModelFeatures, EmptyFeatures]) -> Union[
        ...
        try:
            ...
            energy_prediction = self.__model.predict(sample_df, self.__model_type)[0]
    ...
    @abstractmethod
    def _calculate_energy_per_resource(self, sample: Union[EnergyModelFeatures, EmptyFeatures],
