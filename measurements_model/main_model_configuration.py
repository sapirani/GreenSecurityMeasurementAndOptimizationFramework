...
PROCESS_NAME = NO_SCAN_HEAVYLOAD_PROCESS if IS_NO_SCAN_MODE and isinstance(MEASUREMENTS_SUMMARY_VERSION,
                                                                           DuduSummaryVersionCols) else RANDOM_PROCESS_WITH_OTHER_SUMMARY_VERSION  # change accordingly to the process that we want to monitor in the all processes file
