...
#             cpu_seconds_system=data_row[SystemColumns.CPU_SYSTEM_COL],
#             memory_mb_relative_system=data_row[MemoryColumns.USED_MEMORY],
#             disk_read_kb_system=data_row[DiskIOColumns.READ_BYTES],
#             disk_read_count_system=data_row[DiskIOColumns.READ_COUNT],
#             disk_write_kb_system=data_row[DiskIOColumns.WRITE_BYTES],
#             disk_write_count_system=data_row[DiskIOColumns.WRITE_COUNT],
#             disk_read_time_ms_system=data_row[DiskIOColumns.READ_TIME],
#             disk_write_time_ms_system=data_row[DiskIOColumns.WRITE_TIME],
...
#             cpu_time_process=data_row[ProcessesColumns.CPU_SUM_ACROSS_CORES],
#             memory_mb_relative_process=data_row[ProcessesColumns.USED_MEMORY],
#             disk_read_kb_process=data_row[ProcessesColumns.READ_BYTES],
#             disk_read_count_process=data_row[ProcessesColumns.READ_COUNT],
#             disk_write_kb_process=data_row[ProcessesColumns.WRITE_BYTES],
#             disk_write_count_process=data_row[ProcessesColumns.WRITE_COUNT],
