...
"""
    ...
    if os.path.exists(r"C:\Users\Administrator\Desktop\green security\code\AnalyzeData\Signatures_dataset_after_merge.csv"):
        df = pd.read_csv("Signatures_dataset_after_merge.csv")
    else:
        df = preprocess_data()  # preprocess the date column
        df.to_csv("Signatures_dataset_after_merge.csv")
