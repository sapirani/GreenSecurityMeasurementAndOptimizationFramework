...
def process_resource_usage_recorder_factory(
    ...
    elif process_monitor_type == ProcessMonitorType.SPLUNK:
        return SplunkProcessesResourceUsageRecorder(process_network_monitor, running_os, should_ignore_process)
